...
#if ULSP
        specialScenes.Add("Login", "Assets/Addons/ULoginSystemPro/Content/Scenes/Login.unity");
        specialScenes.Add("Admin Panel", "Assets/Addons/ULoginSystemPro/Content/Scenes/AdminPanel.unity");
#endif
#if CLASS_CUSTOMIZER
