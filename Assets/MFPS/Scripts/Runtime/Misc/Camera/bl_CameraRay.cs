...
public class bl_CameraRay : bl_CameraRayBase
{
    ...
    public Vector3 boxDimesion = new(0.15f, 0.15f, 0.1f);
    #endregion
    ...
    private readonly List<byte> activers = new();
    private readonly Dictionary<string, Action<bool>> triggers = new();
    ...
    void Fire()
    {
        ...
        {
            Ray r = new(CachedTransform.position, CachedTransform.forward);
    ...
    void OnHit()
    {
        if (RayHit.transform.TryGetComponent<IRayDetectable>(out var item))
        {
